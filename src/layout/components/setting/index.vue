...
/* body layout 속성을 추가하여 src/style/sidebar.scss에 작용 */
...
/** 웹 페이지가 다크 모드일 때 밝은 흰색 전환 옵션을 표시하지 않기 */
...
<template>
  <panel>
    ...
    <el-divider>네비게이션 바 모드</el-divider>
    <ul class="pure-theme">
      <el-tooltip
    ...
    <el-divider>인터페이스 디스플레이</el-divider>
    <ul class="setting">
      <li>
        <span class="dark:text-white">그레이 패턴</span>
        <el-switch
      ...
      <li>
        <span class="dark:text-white">색약 모드</span>
        <el-switch
      ...
      <li>
        <span class="dark:text-white">탭 숨기기</span>
        <el-switch
      ...
      <li>
        <span class="dark:text-white">사이드바 Logo</span>
        <el-switch
          v-model="logoVal"
          inline-prompt
          :active-value="true"
      ...
      <li>
        <span class="dark:text-white">탭 지속성</span>
        <el-switch
      ...
      <li>
        <span class="dark:text-white">태그 스타일</span>
        <el-radio-group v-model="markValue" size="small" @change="onChange">
          <el-radio label="card">카드</el-radio>
          <el-radio label="smart">스마트</el-radio>
        </el-radio-group>
      </li>
    </ul>
